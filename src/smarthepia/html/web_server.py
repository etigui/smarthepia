...
def email_html_web_server(host, username):
    return '''
    <html lang="en">
                                        ...
                                        <td>
                                            <table bgcolor="#00b5b8" border="0" cellpadding="0" cellspacing="0" style="min-width: 332px; max-width: 600px; border: 1px solid #F0F0F0; border-bottom: 0; border-top-left-radius: 3px; border-top-right-radius: 3px;" width="100%">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td width="32px"></td>
                                                        <td style="font-family: Roboto-Regular,Helvetica,Arial,sans-serif; font-size: 24px; color: #FFFFFF; line-height: 1.25; min-width: 300px; text-align: center;">Smarthepia web server is not available</td>
                                                        <td width="32px"></td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <table border="0" cellpadding="0" cellspacing="0" style="min-width: 300px;">
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        <td style="font-family: Roboto-Regular,Helvetica,Arial,sans-serif; font-size: 13px; color: #202020; line-height: 1.5;padding: 4px 0;">Today the ''' + datetime.datetime.now().strftime("%d.%m.%Y") + ''' at  ''' + datetime.datetime.now().strftime("%H:%M:%S") + ''' the connection to the Smarthepia web server failed. As a result the whole system is not working properly.
                                                                            <br>
